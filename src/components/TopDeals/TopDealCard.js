...
import { Content4Column4, CustomButton, GeneralMdText, GeneralSmText } from '../../assets/styles/GlobalStyles'
  ...
  return (
    ...
    <Content4Column4>
        <TopDealCardList>
            ...
            <CustomButton width="35%" margin="15px 0 5px" color="var(--primary)" background="transparent" border="1px solid var(--primary)" fontWeight="600" textAlign="center"><AddCartIcon src={shoppingCart} /> Add</CustomButton>
        </TopDealCardList>
    </Content4Column4>
    </>
  )
